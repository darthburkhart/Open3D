...
__device__
void RegistrationCudaDevice2::ComputePointwiseColoredJacobianAndResidual(
    int source_idx,
    int target_idx,
    Vector6f &jacobian_I,
    Vector6f &jacobian_G,
...
__device__
void RegistrationCudaDevice2::ComputePointwisePointToPlaneJacobianAndResidual(
...
__device__
void RegistrationCudaDevice2::ComputePointwisePointToPointSigmaAndResidual(
    int source_idx, int target_idx,
...
__device__
void RegistrationCudaDevice2::ComputePixelwiseInformationJacobian(
...
__device__
void RegistrationCudaDevice2::ComputePointwiseColorGradient(
