...
__global__
void ReciprocityTestKernel2(FastGlobalRegistrationCudaDevice2 device) {
...
__global__
void TupleTestKernel2(FastGlobalRegistrationCudaDevice2 device,
...
void FastGlobalRegistrationCudaKernelCaller2::TupleTest(
    FastGlobalRegistrationCuda2 &fgr) {
...
void ComputeResultsAndTransformationKernel2(
    FastGlobalRegistrationCudaDevice2 fgr) {
...
void FastGlobalRegistrationCudaKernelCaller2::ComputeResultsAndTransformation(
    FastGlobalRegistrationCuda2 &fgr) {
